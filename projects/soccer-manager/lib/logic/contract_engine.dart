...
class ContractEngine {
  ...
  /// 契約更新にかかる基本費用(万円)。代理人への手数料にあたる。
  /// ローン選手には適用されない。
  ///
  /// 以前は市場価値の50%だった。総合90の選手で2,038万円で、サインボーナスと
  /// 合わせて2,527万円。**契約を更新するのに移籍金の半額を払う**形になっていて、
  /// 選手が育つほど手元に残せなくなっていた(実際にそう遊びづらいという声が
  /// 出た)。移籍で獲るのと更新で残すのが同じ値段では、育てる意味が薄い。
  ///
