...
出典（2026-09-26 に一次情報で確認）:
- 企業規模要件の段階（36人・21人・11人・撤廃）: 厚生労働省 社会保険適用拡大特設サイト
  https://www.mhlw.go.jp/tekiyoukakudai/jugyouin/taisho/ と日本年金機構
  https://www.nenkin.go.jp/service/kounen/tekiyo/jigyosho/tanjikan.html
- 賃金要件の撤廃日: 令和7年法律第74号 附則第1条第1項第9号の施行期日を
  **令和8年10月1日** と定めた「令和8年政令第275号」（令和8年9月11日 官報号外第203号 7頁）。
  厚労省・年金機構のページは公布前の「撤廃予定」の書き方のまま
...
3. 学生でないこと（卒業前に就職して卒業後も同じ事業所で働く予定の人・夜間や定時制の
   課程の人・休学中の人は対象。日本年金機構のページで確認。厚労省は通信制も挙げている）
