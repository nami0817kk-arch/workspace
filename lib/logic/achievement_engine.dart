...
class AchievementEngine {
  // static final ではなくゲッターにしている。final にすると最初のアクセス時に
  // 実績名・条件文が組み立てられ、そのときの言語で固定されてしまう。設定で
  // 日本語/英語を切り替えても実績画面だけ変わらない、という状態を避けるため。
  static List<Achievement> get all => [
        ...
        Achievement(
          ...
          isUnlocked: (save, team) =>
              save.seasonHistory.any((r) => r.wonLeague),
        ),
        Achievement(
          id: 'back_to_back',
          category: AchievementCategory.title,
          ...
          description: Tr.pick(
              '2シーズン連続でリーグ優勝を果たす', 'Win the league two seasons running'),
          isUnlocked: (save, team) =>
        ...
        Achievement(
          ...
          isUnlocked: (save, team) => save.seasonHistory
              .any((r) => r.wonLeague && r.cupsWon.isNotEmpty),
        ),
        Achievement(
          id: 'five_titles',
          category: AchievementCategory.title,
          ...
          description: Tr.pick(
              '通算タイトル(リーグ優勝+カップ優勝)を5回獲得する', 'Win five trophies in total'),
          isUnlocked: (save, team) =>
        ...
        Achievement(
          ...
          description:
              Tr.pick('監督として通算100勝を挙げる', 'Reach 100 wins as a manager'),
        ...
        Achievement(
          ...
          description:
              Tr.pick('監督として通算200勝を挙げる', 'Reach 200 wins as a manager'),
        ...
        Achievement(
          ...
          description: Tr.pick(
              '同一クラブで5シーズンを指揮する', 'Manage the same club for five seasons'),
        ...
        Achievement(
          ...
          description: Tr.pick(
              '同一クラブで10シーズンを指揮する', 'Manage the same club for ten seasons'),
        ...
        Achievement(
          ...
          isUnlocked: (save, team) {
            final total =
                save.careerWins + save.careerDraws + save.careerLosses;
        ...
        Achievement(
          ...
          description: Tr.pick('下位ディビジョンから上位ディビジョンへの昇格を果たす',
              'Win promotion to a higher division'),
        ...
        Achievement(
          ...
          description: Tr.pick(
              'クラブ資金が3万(万円)に到達する', "Build the club's funds up to 30,000"),
        ...
        Achievement(
          ...
          description: Tr.pick(
              'カップ戦の賞金を通算1000万円獲得する', 'Collect 1,000 in cup prize money'),
        ...
        Achievement(
          ...
          description: Tr.pick('総合力80以上の選手を5人以上保有する',
              'Have five or more players rated 80 or above'),
          isUnlocked: (save, team) =>
        ...
        Achievement(
          ...
          description: Tr.pick('選手を1人殿堂入り(引退)させる',
              'See one of your players into the hall of fame'),
        ...
        Achievement(
          ...
          description: Tr.pick(
              '5人の選手を殿堂入りさせる', 'See five players into the hall of fame'),
