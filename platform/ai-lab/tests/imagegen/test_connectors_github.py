...
from imagegen.connectors.github import API_BASE, GitHubConnector
from imagegen.core.errors import AuthError, ConfigError
...
def test_publish_uses_default_repo_from_env(monkeypatch, png):
    monkeypatch.setenv("IMAGEGEN_GITHUB_REPO", REPO)
...
def test_publish_rejects_oversized_file(tmp_path, monkeypatch):
    ...
    big.write_bytes(b"0")
    monkeypatch.setattr("imagegen.connectors.github.MAX_BYTES", 0)
...
def test_github_has_both_capabilities():
    from imagegen.core import capabilities_of
