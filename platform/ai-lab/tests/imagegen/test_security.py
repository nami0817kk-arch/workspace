...
from imagegen import cli, mcp_server, usage
from imagegen.core import http
from imagegen.core.errors import ImagegenError
from imagegen.core.redact import redact, secret_values
...
def test_prompt_recording_can_be_disabled(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("IMAGEGEN_USAGE_PROMPTS", "0")
