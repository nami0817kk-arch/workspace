...
from imagegen.connectors.images_gemini import BASE_URL, GeminiImages
from imagegen.connectors.images_local import LocalImages
from imagegen.connectors.images_openai import API_URL, OpenAIImages
from imagegen.connectors.images_stability import StabilityImages
from imagegen.core.errors import AuthError, ConnectorError
from imagegen.utils import ASPECT_RATIOS, closest_aspect_ratio
...
def test_model_falls_back_to_environment(monkeypatch):
    ...
    monkeypatch.setenv("IMAGEGEN_OPENAI_MODEL", "gpt-image-3")
