...
from imagegen.connectors.assets_openverse import API_URL as OPENVERSE_URL
from imagegen.connectors.assets_openverse import OpenverseAssets
from imagegen.connectors.assets_pixabay import PixabayAssets
...
def test_worker_count_is_configurable(monkeypatch):
    monkeypatch.setenv("IMAGEGEN_MAX_WORKERS", "8")
    assert assets.max_workers() == 8
    monkeypatch.setenv("IMAGEGEN_MAX_WORKERS", "おかしな値")
