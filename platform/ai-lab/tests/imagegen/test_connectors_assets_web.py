...
from imagegen.connectors.assets_iconify import MIN_LIMIT, SVG_URL, IconifyAssets
from imagegen.connectors.assets_pexels import PexelsAssets
from imagegen.connectors.assets_unsplash import UnsplashAssets
...
def test_search_all_includes_iconify(monkeypatch):
    ...
    for cls in (
        __import__("imagegen.connectors.assets_openverse", fromlist=["OpenverseAssets"]).OpenverseAssets,
        __import__("imagegen.connectors.assets_wikimedia", fromlist=["WikimediaAssets"]).WikimediaAssets,
    ):
